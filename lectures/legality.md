...
- As with previous lectures such as on social harms,
many of these laws are not specific to large language models
(there is no Large Language Model Act).
- But whenever a **new powerful technology** emerges,
it raises many questions about whether existing laws still apply or make sense if they do.
...
- ethics is not enforceable and can be made by any organization.
...
- We will focus by default on United States, but will mention the EU at various times,
  since they are leading the charge with data privacy and AI regulation.
...
- **Statuatory law** (legislature):
  Also known as written law, statuatory law is produced by government agencies through the legislative process (e.g., congress passing a bill).
...
1. [Copyright law](#copyright-law)
1. [Privacy law](#privacy-law)

## Copyright law

Large language models, or any machine learning approach,
...
- Types: copyright, patents, trademarks, secrets
- We will focus
- Provide creators with rights (e.g., to sell, perform, etc.) to the created goods for some period of time
- Provide **economic incentives** for creating new goods
...
- [Examples](https://en.wikipedia.org/wiki/List_of_major_Creative_Commons_licensed_works) include Wikipedia, Open Courseware, Khan Academy,
  Free Music Archive, 307 million images from Flickr, 39 million images from MusicBrainz, etc.

**Fair use (section 107)**.
- Summary: allows people to use copyrighted material for other uses under some conditions.
...
- Example of fair use: reimplement an algorithm rather than copying the code
...
- Impossible to get a license from all the individuals.
- Database owner might not have license to individual works, license might not protect novel use case.
- Copying data (first step of training) is violation already even if you don't do anything with it.
- Statuatory damages are up to $150,000 per work (Section 504 of Copyright Act).
...
- 2013: District Court granted [summary judgement](https://en.wikipedia.org/wiki/Summary_judgment) in favor of Google, deemed **fair use**.
...
- 2003: 9th circuit ruled in fovor of favor Arriba, deemed it **fair use**.
...
- Arguments against ML as fair use:
  ...
  * Problems with ML systems (spread disinormation, enable surveillance, etc.), so don't give ML systems the benefit of the doubt.
...
**Changes**.
- First phase: text data mining (search engines) - simple pattern matching.
- Second phase: classification (e.g., classify stop signs or sentiment analysis), recommendation systems.
- Third phase: **generative models** can learn to mimic expression.
  ...
  * However, this has copyright implications since a language model can compete with writers.
  * For example: writer writes three books, a language model trains on these three books, and auto-generates the fourth.
...
- Founded in 2017
- [New York Times article](https://www.nytimes.com/2020/01/18/technology/clearview-privacy-facial-recognition.html) exposes in 2019
- As of October 2021, scraped 10 billion images of faces from Facebook, Twitter, Google, YouTube, Venmo, etc.
- Sells data to law enforcement agencies (e.g., FBI) and commercial organizations.
...
[California's bot disclosure
bill](https://www.natlawreview.com/article/california-s-bot-disclosure-law-sb-1001-now-effect):
...
- As we're training large language models, have to confront copyright and fair use.
- The **uncurated** nature of web crawls means you have to with fair use.
- The **generative** aspect of models might present challenges for arguing fair use (can compete with humans).
- What level to regulate (at language models or downstream applications)?
...
- [Internet laws](https://www.kaspersky.com/resource-center/preemptive-safety/internet-laws)
- [Internet law](https://www.upcounsel.com/internet-law)
